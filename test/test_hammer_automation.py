...
class TestTacticBuilder:
    ...
    @pytest.mark.requires_coq
    def test_contract_build_tactic_produces_valid_coq(self):
        ...
        """
        build_tactic = _import_build_tactic()
        pytest.skip("Requires live Coq backend for syntax validation")
...
class TestResultInterpreter:
    ...
    def test_contract_interpret_result_real_coq_output(self):
        ...
        interpret_result = _import_interpret_result()
        pytest.skip("Requires real Coq output samples")
